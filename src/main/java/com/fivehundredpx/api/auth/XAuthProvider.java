...
public class XAuthProvider implements OAuthProvider {
	...
	public void signForAccessToken(HttpPost req) throws FiveHundredException, UnsupportedEncodingException {
	...
	private String getSignatureBaseString(HttpPost req, OAuthParameters params) throws UnsupportedEncodingException {
		final String method = req.getMethod();
		final String url = URLEncoder.encode(req.getURI().toString(),"UTF-8");

		final String sortedParams = URLEncoder.encode(params
				.getSortedEncodedParamsAsString(),"UTF-8");
